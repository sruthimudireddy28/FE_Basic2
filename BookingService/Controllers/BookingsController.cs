...
namespace BookingService.Controllers
{
    ...
    public class BookingsController : ControllerBase
    {
        ...
        [HttpPut("{id}/payment")]
        [AllowAnonymous] // Called internally by PaymentService (no user JWT in that call)
        public async Task<IActionResult> UpdateBookingPayment(int id, [FromBody] UpdatePaymentDto request)
        {
    ...
    // DTO for the payment update endpoint
