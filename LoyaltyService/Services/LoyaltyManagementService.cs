...
namespace LoyaltyService.Services
{
    public class LoyaltyManagementService : ILoyaltyManagementService
    {
        ...
        private const decimal PointsPerDollar = 0.5m;
        private const decimal PointValueInDollars = 0.02m;
        ...
        // to check the the locayaty account in that account balance is there 
